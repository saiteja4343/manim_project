...
class Conv(Scene):
    def construct(self):
        ...
        res_text = Tex("5").next_to(cal_text, np.array((1.0, 0.0, 0.0))).scale(0.75)
        ...
        res_text2 = Tex("9").next_to(cal_text, np.array((1.0, 0.0, 0.0))).scale(0.75)
        ...
        self.wait()
        cal_text3 = Tex("(0*2)+(1*1)+(3*0)+(4*1) =").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(ReplacementTransform(cal_text2, cal_text3), run_time=1)
        self.wait()

        res_text3 = Tex("5").next_to(cal_text, np.array((1.0, 0.0, 0.0))).scale(0.75)
