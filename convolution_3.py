...
class Conv(Scene):
    def construct(self):
        ...
        cal_text = Tex("(0*2)+(1*1)+(3*0)+(4*1)").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(FadeIn(cal_text), run_time=1)
        self.wait()

        equal2 = Tex("=").next_to(cal_text, np.array((0.5, 0.0, 0.0))).scale(0.75)
        self.play(FadeIn(equal2), run_time=1)
        self.wait()
        ...
        self.play(FadeOut(equal2), run_time=0.5)
        self.wait()

        self.play(FadeOut(res_text), run_time=0.5)
        self.wait()
        ...
        cal_text2 = Tex("(1*2)+(2*1)+(4*0)+(5*1)").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(ReplacementTransform(cal_text, cal_text2), run_time=1)
        self.wait()

        res_text2 = Tex("9").next_to(equal2, np.array((1.0, 0.0, 0.0))).scale(0.75)
        ...
        self.play(FadeOut(res_text2), run_time=0.5)
        self.wait()
        ...
        self.wait()
        cal_text3 = Tex("(2*2)+(1*1)+(5*0)+(4*1)").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(ReplacementTransform(cal_text2, cal_text3), run_time=1)
        self.wait()

        res_text3 = Tex("9").next_to(equal2, np.array((1.0, 0.0, 0.0))).scale(0.75)
        ...
        self.play(FadeOut(res_text3), run_time=0.5)
        self.wait()
        ...
        self.wait()
        cal_text4 = Tex("(3*2)+(2*1)+(2*0)+(1*1)").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(ReplacementTransform(cal_text3, cal_text4), run_time=1)
        self.wait()

        res_text4 = Tex("9").next_to(equal2, np.array((1.0, 0.0, 0.0))).scale(0.75)
        self.play(FadeIn(equal2), run_time=0.5)
        self.wait()
