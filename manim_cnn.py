...
class MNISTCNN(ThreeDScene):
    def construct(self):
        ...
        nn.move_to(np.array((-0.75, 0.0, 0.0)))
        ...
        in_text = Tex(layer_names[0]).next_to(np.array((-3.5, -1.25, 0.0)), DOWN)
        in_text.scale(0.35)  # Decrease the font size by scaling
        self.play(FadeIn(in_text), run_time=0.5)

        conv_text1 = Tex(layer_names[1] + "1").next_to(np.array((-2.0, -1.25, 0.0)), DOWN)
        ...
        pool_text1 = Tex(layer_names[1] + "2").next_to(np.array((0.25, -1.25, 0.0)), DOWN)
        ...
        conv_text2 = Tex(layer_names[1] + "3").next_to(np.array((1.8, -1.25, 0.0)), DOWN)
        ...
        pool_text2 = Tex(layer_names[1] + "4").next_to(np.array((3.2, -1.25, 0.0)), DOWN)
        ...
        out_text = Tex(layer_names[2]).next_to(np.array((4.45, -1.25, 0.0)), DOWN)
