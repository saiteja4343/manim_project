...
class Conv(Scene):
    def construct(self):
        ...
        res_text = Tex("10").next_to(equal2, np.array((0.5, 0.0, 0.0))).scale(0.75)
        ...
        res_text2 = Tex("17").next_to(equal2, np.array((1.0, 0.0, 0.0))).scale(0.75)
        ...
        self.wait()
        cal_text3 = Tex("(2*2)+(1*3)+(5*1)+(4*1)").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(ReplacementTransform(cal_text2, cal_text3), run_time=1)
        self.wait()

        res_text3 = Tex("16").next_to(equal2, np.array((1.0, 0.0, 0.0))).scale(0.75)
        ...
        self.wait()
        cal_text4 = Tex("(3*2)+(2*3)+(2*1)+(1*1)").next_to(kernel, np.array((0.0, -6.0, 0.0))).scale(0.75)
        self.play(ReplacementTransform(cal_text3, cal_text4), run_time=1)
        self.wait()

        res_text4 = Tex("15").next_to(equal2, np.array((1.0, 0.0, 0.0))).scale(0.75)
        self.play(FadeIn(equal2), run_time=0.5)
        self.wait()
